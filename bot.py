...
def start(message):
    ...
    bot.send_message(chat_id,
                     ...
                     f"А для начала взаимодействия со мной по вашему путешествию напишите /set_town и укажите город, также вам следует узаать интересующую вас страну через команду /set_country. Затем вам станет доступны другие команды, их нужно использовать п\n",
